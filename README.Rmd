...
```{r number_suits, echo=FALSE, fig.alt = "Some mathematical bold numbers in Dotaro Ranks and number suit symbols in Dotaro Suits shown as card indices"}
bold_digits <- c(
    "\U0001D7CE", # 𝟎
    "\U0001D7CF", # 𝟏
    "\U0001D7D0", # 𝟐
...
df <- dotaro.font:::df_index(bold_digits, suits = "numbers")
dotaro.font:::grid.index(df, bleed = "white")
```
